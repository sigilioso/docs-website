    ...
    <tr>
      ...
      <td>
        ...
        * `/etc/sysconfig/varnish/varnish.params`
          ...
          For 6 and above, this parameter should not be set and the integration should be set up for metrics collection only. See [the example for Varnish 6](#example6).
      </td>
